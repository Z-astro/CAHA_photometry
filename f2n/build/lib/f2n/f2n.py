...
# Hao Zhang Modification in Jul29 2025
# __init__(), __str__(), setzscale(), pilcoords(), tonet(), fromfits(), rebin(), remax(), __main__
# pyfits is changed to astropy.io
...
#		return pythoncopy.deepcopy(self)	
	...
	def setzscale(self, z1="auto", z2="auto", nsig=3, samplesizelimit = 10000, border=300, satlevel=65000):
		...
		# 改动：使用 isinstance 替代旧的类型检查，更具鲁棒性
		if z1 == "ex":
			self.z1 = np.min(calcarray)
			if self.verbose:
				print("Setting ex z1 to %f" % self.z1)
